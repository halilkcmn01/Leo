...
public class Diyet2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diyet2);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (id==0){
                    textView.setText(R.string.diyet2sabah);
                }else if(id==1){
                    textView.setText(R.string.diyet2oglen);
                }else if(id==2){
                    textView.setText(R.string.diyet2aksam);
                }
