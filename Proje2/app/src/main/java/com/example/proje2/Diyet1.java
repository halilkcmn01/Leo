...
public class Diyet1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diyet1);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (id==0){
                    textView.setText(R.string.diyet1sabah);
                }else if(id==1){
                    textView.setText(R.string.diyet1oglen);
                }else if(id==2){
                    textView.setText(R.string.diyet1aksam);
                }
